    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if ((act == null) || (act.equals("vide"))) {
            ...
            if (!(login.trim().isEmpty()) || !(pass.trim().isEmpty())) {
                ...
                if (utilisateur != null) {
                    ...
                    if (utilisateur.getProfilTechique() == ProfilTechnique.Admin || utilisateur.getProfilTechique() == ProfilTechnique.Visiteur) {
                        ...
                        } else if (utilisateur.getProfilTechique() == ProfilTechnique.Visiteur) {
                            jspClient = "/Employe/dashboardAdmin.jsp";
                        }
                    } else if (utilisateur.getProfilTechique() == ProfilTechnique.Gestion) {
                        List<Communication> listeCommunication = new ArrayList<>();
            ...
            if (test != null && test.equals("affecter")) {
                ...
                if (listeUtilisateurHardisReponseContactMail == null) {
                    listeUtilisateurHardisReponseContactMail = new ArrayList<>();
                }
            ...
            if (listeCommunication == null) {
                listeCommunication = new ArrayList<>();
            }
            if (listeNotif == null) {
            ...
            if (listhistdevis == null) {
                listhistdevis = new ArrayList<>();
            }
            ...
            if (listeLivrable == null) {
                listeLivrable = new ArrayList<>();
            }
            ...
            if (listlivrable == null) {
                listlivrable = new ArrayList<>();
            }
            request.setAttribute("listoffre", listoffre);
            ...
            if (listeServiceStandard == null) {
                listeServiceStandard = new ArrayList<>();
            }
            ...
            if (listeUtilisateurHardis == null) {
            ...
            if (listeCommunicationDevis == null) {
                listeCommunicationDevis = new ArrayList<>();
            }
            ...
            if (listeOffress == null) {
                listeOffress = new ArrayList<>();
            }
            List<UtilisateurHardis> listeUtilisateurHardis = administrateurHardisSession.listUtilisateurHardis();
            if (listeUtilisateurHardis == null) {
                listeUtilisateurHardis = new ArrayList<>();
...
//                        opcv = administrateurHardisSession.rechercheOPUCParUtilisateurEtOffre(utili, offree);
                    ...
                    if (!plafondpfcv.equalsIgnoreCase("")) {
                        for (Long ididPM : liidPM) {
                            ...
                            if (plafondpfcv.equalsIgnoreCase("")) {
                                ...
                                plafond = Float.valueOf(plafondpfcv);
                            }
                            administrateurHardisSession.modifierProfilMetier(pmm.getId(), niveauH, exp, plafond, null, utili);
                        }
                    }
    ...
    protected void doActionEnvoyerMail(HttpServletRequest request, HttpServletResponse response)
        ...
        if (emailto.trim().isEmpty() || messagemail.trim().isEmpty()) {
            ...
            UtilisateurHardis ut = (UtilisateurHardis) sess.getAttribute("utilisateur");
            if (ut != null) {
                Long idevis = Long.valueOf(iddev);
                Devis devis = administrateurHardisSession.rechercherDevis(idevis, ut);
