  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Afficher Entreprise</li>
      </ol>
    </section>
        ...
        <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <tr>
                  <td><a href="servAdmin?action=formEntreprise&idEntreprise=<%=a.getId().toString() %>" name="idEntreprise" value="<%=a.getId().toString() %>"><%=a.getNomEntreprise() %></a></td>
