...
<head>
  ...
  <%@include  file = "meta.jsp" %>
    ...
    <jsp:useBean id="listeLivrable" scope="request" class = "java.util.List"> </jsp:useBean>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Livrable</li>
        <li class="active">Afficher Livrable</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <% List<Livrable> lesLivrables=listeLivrable; %> 
      <!-- /.row -->
      <!-- Main row -->
      <div class="row">
        <!-- left column -->
        <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <% for (Livrable a : lesLivrables){%>
     
                <tbody>
                <tr>
                  <td><%=a.getNomLivrable() %></td>
                  <% List<ServiceStandard> lesServ =a.getService(); %> 
