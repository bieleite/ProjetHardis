...
<script>(function(i,s,o,g,r,a,m){i["GoogleAnalyticsObject"]=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,"script","//www.google-analytics.com/analytics.js","ga");ga("create", "UA-8808399-3", {"cookieDomain":"auto"});ga("set", "anonymizeIp", true);ga("send", "pageview");</script>
...
<li class="expanded dropdown yamm-fw level_1 no-big-menu mlid-666"><a title="" data-target="#" class="dropdown-toggle nolink" data-toggle="dropdown">Votre secteur <span class="caret"></span></a><ul class="dropdown-menu row"><li class="first leaf level_2 col-sm-3 col-xs-12"><a href="/votre-secteur/transformation-digitale-et-metier-des-assurances-et-mutuelles" title="Assurances, mutuelles : la digitalisation et l’innovation au service de vos clients">Assurance et mutuelle</a></li>
<li class="leaf level_2 col-sm-3 col-xs-12"><a href="/votre-secteur/transformation-digitale-des-banques-et-etablissements-financiers" title="Transformation digitale des banques et établissements financiers">Banque et finance</a></li>
<li class="leaf level_2 col-sm-3 col-xs-12"><a href="/votre-secteur/industriels-transformez-vous-par-les-services-et-le-digital" title="Industriels : transformez-vous par les services et le digital">Manufacturing et énergie</a></li>
<li class="leaf level_2 col-sm-3 col-xs-12"><a href="/votre-secteur/prestataires-logistiques-et-transports-developpement-et-differenciation" title="Prestataires logistiques et transports : développement et différenciation métier">Prestataires logistiques et transport</a></li>
<li class="collapsed level_2 col-sm-3 col-xs-12"><a href="/votre-secteur/commerce-connecte-offrez-une-experience-omnicanal-vos-clients" title="Commerce connecté : offrez une expérience omnicanal à vos clients">Distribution, luxe et CPG</a></li>
<li class="last leaf level_2 col-sm-3 col-xs-12"><a href="/votre-secteur/secteur-public-faites-vous-accompagner-par-un-acteur-innovant-du-territoire" title="Secteur public : faites-vous accompagner par un acteur innovant du territoire">Secteur public</a></li>
</ul></li>
<li class="expanded dropdown yamm-fw level_1 no-big-menu mlid-664"><a title="" data-target="#" class="dropdown-toggle nolink" data-toggle="dropdown">Innovation et transformation <span class="caret"></span></a><ul class="dropdown-menu row"><li class="first leaf level_2 col-sm-3 col-xs-12"><a href="/innovation/creer-de-la-valeur-business-par-la-digitalisation-des-services" title="Créer de la valeur business par la digitalisation des services">Digitalisation des services</a></li>
<li class="leaf level_2 col-sm-3 col-xs-12"><a href="/innovation/gestion-et-transformation-de-votre-systeme-dinformation" title="Gestion et transformation de votre système d&#039;information">Transformation du SI</a></li>
<li class="leaf level_2 col-sm-3 col-xs-12"><a href="/innovation/concretisez-vos-nouveaux-business-model-autour-des-objets-connectes" title="Concrétisez vos nouveaux business model autour des objets connectés">Objets connectés</a></li>
<li class="leaf level_2 col-sm-3 col-xs-12"><a href="/innovation/conception-et-integration-de-solutions-drone-sur-mesure" title="Conception et intégration de solutions drone sur mesure">Intégration de solutions drone</a></li>
...
<div class="clearfix hidden-xs"></div>      </header> <!-- /#page-header -->
   ...
   <div id="carousel-twitter" class="carousel slide" data-ride="carousel" data-interval="4000">
    <!-- Carousel items -->
    <div class="carousel-inner">
              <div class="item active">
            <span class="twitter-logo"><a href="https://twitter.com/groupehardis" target="_blank">TW</a></span> 🎙 En direct de eCl<a href="https://twitter.com/ss" target="_blank">@ss</a> day dans les locaux de Schneider Electric pour la journée d'information dédiée au référentiel… <a href="https://t.co/rjygFrveWD" target="_blank">https://t.co/rjygFrveWD</a>        </div>
              <div class="item">
            <span class="twitter-logo"><a href="https://twitter.com/groupehardis" target="_blank">TW</a></span> 🎙 Nous étions présents dans le cadre de la Biennale de la Logistique à la journée dédiée à l'innovation et la logis… <a href="https://t.co/BMYl2NFmbb" target="_blank">https://t.co/BMYl2NFmbb</a>        </div>
              <div class="item">
            <span class="twitter-logo"><a href="https://twitter.com/groupehardis" target="_blank">TW</a></span> 🤝 Dans le cadre de notre partenariat avec <a href="https://twitter.com/LeVillagebyCA" target="_blank">@LeVillagebyCA</a> nous accompagnons COMONGO dans la définition de scenari po… <a href="https://t.co/yjNUqsoyLQ" target="_blank">https://t.co/yjNUqsoyLQ</a>        </div>
              <div class="item">
            <span class="twitter-logo"><a href="https://twitter.com/groupehardis" target="_blank">TW</a></span> 📆 Nous serons présents au <a href="https://twitter.com/SITLevents" target="_blank">@SITLevents</a>  du 26 au 28 mars ! 
Venez découvrir Logistics Everywhere, échanger sur vos d… <a href="https://t.co/QbkRTKw2DW" target="_blank">https://t.co/QbkRTKw2DW</a>        </div>
          </div>
  </div>
</section>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 hidden-xs">
          <a href="/"><img src="/sites/all/themes/hardis/img/logo_footer.jpg" class="img-responsive"></a>
        </div>
