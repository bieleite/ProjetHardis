        ...
        <div class="box">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                <tr>
                    <td><a href="servEmployes?action=formDevis&idDevis=<%=devis.getId().toString() %>" name="idDevis" value="<%=devis.getId().toString() %>">DEV<%=devis.getId()%></a></td>
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <div class="box-tools pull-right">
                    <a href="servEmployes?action=formDevis&idDevis=<%=devistraitement.getId().toString() %>" name="idDevis" value="<%=devistraitement.getId().toString() %>"><button type="button" class="btn btn-block btn-primary">Affecter Devis</button></a>
            </div>
