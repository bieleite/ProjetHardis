        ...
        <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <tr>
                    <td><a href="servEmployes?action=formUtilisateur&idUtili=<%=a.getId().toString() %>" name="idUtili" value="<%=a.getId().toString() %>"><%=a.getNom() %></a></td>
                  <td><%=a.getPrenom() %></td>
                  <td><%=a.getLogin() %></td>
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <label for="metUtili">Profil Metier</label><a href="servEmployes?action=formUtilisateur&acao=modif&idUtili=<%=utili.getId().toString() %>" ><button type="button" class="btn btn-default btn-sm active"><i class="fa fa-edit"></i></button></a>
